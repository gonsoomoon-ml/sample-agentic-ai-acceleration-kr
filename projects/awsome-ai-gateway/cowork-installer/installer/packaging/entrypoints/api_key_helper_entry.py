"""PyInstaller entry-point shim for the `api-key-helper` console script.

Mirrors [tool.poetry.scripts] api-key-helper = "api_key_helper.main:main".
"""
...
from api_key_helper.main import main
